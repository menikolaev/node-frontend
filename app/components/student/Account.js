...
class Account extends React.Component {
  ...
  render() {
    return (
      <div>
      <h1>Account</h1>
      <TextField hintText="Фамилия" floatingLabelText="Фамилия"
        onChange={AccountActions.updateSurname}/><br/>
      <TextField hintText="Имя" floatingLabelText="Имя" onChange={AccountActions.updateName}/><br/>
      <TextField hintText="Отчество" floatingLabelText="Отчество"
        onChange={AccountActions.updatePatronomic}/><br/>
      <TextField hintText="Email" floatingLabelText="Email"
        onChange={AccountActions.updateEmail}/><br/>
      <TextField hintText="Гражданство" floatingLabelText="Гражданство"
        onChange={AccountActions.updateCitizenship}/><br/>
